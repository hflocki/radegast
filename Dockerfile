...
RUN apt-get install -y gnupg net-tools wget curl openssh-client
ENV USER root
...
RUN curl -SL 'https://dl.winehq.org/wine/wine-mono/7.4.0/wine-mono-7.4.0-x86.msi' -o /usr/share/wine/mono/wine-mono-7.4.0-x86.msi
RUN chmod +x /usr/share/wine/mono/wine-mono-7.4.0-x86.msi
